...
export function MenuToggle({
	...
	return (
		<label className={cn("flex cursor-pointer items-center justify-center", className)}>
			...
			<svg
				...
				className={cn('size-6 transition-transform duration-[600ms] ease-out', open && '-rotate-45')}
				{...props}
			>
				<path
					className={cn(
